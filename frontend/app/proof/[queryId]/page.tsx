                            ...
                            <div className="space-y-4">
                                <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-700/50">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-bold text-white mb-1">How Trende Proves This Report</h4>
                                            <p className="text-sm text-slate-400 leading-relaxed">
                                                This report was generated by Trende&apos;s backend runtime on Hetzner, then hashed and
                                                signed server-side. That makes tampering detectable and lets downstream users verify the
                                                exact payload that produced the result.
                                            </p>
                                        </div>
                                    </div>
                                </div>
