              ...
              <div className="lg:col-span-1 space-y-4">
                ...
                <Card accent="cyan" className="p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-black uppercase text-[var(--accent-cyan)]">
                      Forge Ready
                    </span>
                  </div>
                  <p className="text-xs text-[var(--text-secondary)] font-mono mb-3">
                    Conviction dashboard ready for thesis generation.
                  </p>
                  <Link
                    href={
                      activeQueryId ? `/meme/${activeQueryId}?view=meme` : "#"
                    }
                  >
